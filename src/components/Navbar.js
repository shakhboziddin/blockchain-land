...
function Navbar() {
  const st = {
    navbar:
      "flex w-full top-[40px] z-[9999] h-[65px] md:h-[80px] flex-col bg-[#0a0c1f] text-white items-center sticky",
    content:
      "flex items-center justify-between w-[100%] md:w-[85%] lg:w-[80%] max-w-[95%]  m-[auto] py-[9px] px-[10px] shadow-lg",
    ...
    menu_btn:
      "flex lg:hidden lg:absolute lg:top-[-199px] ml-[20px] cursor-pointer text-[30px]",
    phone_menu:
      "lg:hidden bg-[#0a0c1fe6] backdrop-blur-[20px] shadow-lg min-h-[100vh] pb-[300px] relative z-[99999]  w-[100%] px-[20px] duration-[.3s]",
    phone_menu_btn:
      " w-[100%] mt-[20px] text-[15px] cursor-pointer flex items-center justify-between border-b-2 border-[#1e293b] pb-[10px]",
    phone_hr: "",
  };
  ...
  return (
    <div className={st.navbar}>
      ...
      <div
        className={st.phone_menu}
        style={{ transform: menu ? "translateX(0)" : "translateX(-1200px)" }}
      >
